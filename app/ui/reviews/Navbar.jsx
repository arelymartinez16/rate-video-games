    ...
    return (
        <nav className="flex justify-between items-center py-4 bg-gray-800 text-white">
            ...
            <div className='flex space-x-4'>
                ...
                <Link href='/about' className='flex h-[48px] items-center justify-center gap-2 rounded-md p-3 text-sm font-medium md:flex-none md:justify-start md:p-2 md:px-3'>About</Link>
